...
public class RecycleViewAdapterTutorials extends RecyclerView.Adapter<com.example.elementaryapp.recycler_view.ViewHolderTutorials>{
    ...
    @NonNull
    @Override
    public com.example.elementaryapp.recycler_view.ViewHolderTutorials onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.tutorial_item, parent, false);
        return new com.example.elementaryapp.recycler_view.ViewHolderTutorials(view).linkAdapter(this);
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.elementaryapp.recycler_view.ViewHolderTutorials holder, int position) {
...
class ViewHolderTutorials extends RecyclerView.ViewHolder {
    ...
    private com.example.elementaryapp.recycler_view.RecycleViewAdapterTutorials adapter;
...
//        videoView.start();
    ...
    //linking the adapter
    public com.example.elementaryapp.recycler_view.ViewHolderTutorials linkAdapter(com.example.elementaryapp.recycler_view.RecycleViewAdapterTutorials adapter) {
